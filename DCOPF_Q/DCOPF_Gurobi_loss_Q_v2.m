...
for i=1:nb
    for k=1:0.5*length(gencostdata(:,5))
...
Voltagecostmax=(lambda.ineqlin_voltage(1:nb)'*X(nb+1:end,nb+1:end))';
Voltagecostmin=(lambda.ineqlin_voltage(nb+1:end)'*X(nb+1:end,nb+1:end))';
